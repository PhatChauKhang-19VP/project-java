...
public class OrderPane {
    ...
    public OrderPane(Package pkg) {
        ...
        // pane > btnPayPkg
        Button btnPayPkg = new Button("Thanh toán");
        btnPayPkg.setAlignment(Pos.CENTER);
        btnPayPkg.setPrefSize(120, 25);
        btnPayPkg.setLayoutX(66);
        btnPayPkg.setLayoutY(310);
        pane.getChildren().add(btnPayPkg);

        btnPayPkg.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                tq.setEditable(true);
                System.out.println(getClass() + " pay pkg");
